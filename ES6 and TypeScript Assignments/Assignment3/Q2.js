...
const account1 = new SavingAccount(151860002536, "Kanuka Goel", 600000, 2000);
const account2 = new CurrentAccount(151860002537, "Akash Sharawat", 25000, 10000);
const account3 = new SavingAccount(151860002538, "Athira", 90000, 2000);
const account4 = new CurrentAccount(151860002539, "Shilpi Singh", 40000, 5000);
